...
(() => {
  const base = '../..';
  for (const p of ["tokens/palette.css","tokens/color.css","tokens/typography.css","tokens/spacing.css","tokens/radius-elevation.css","tokens/fonts.css","tokens/base.css","styles.css"]) {
