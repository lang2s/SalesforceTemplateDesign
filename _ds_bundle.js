...
(function () {
  ...
  function seed() {
    ...
    Object.keys(starter).forEach(rn => {
      regions[rn] = starter[rn].map(b => ({
        id: uid(),
        type: b.type,
        props: {
          ...b.props
  ...
  function loadState() {
    try {
      ...
      if (s && s.regions && s.layout) return s;
    } catch (e) {}
    return seed();
  }
  ...
  function App() {
    ...
    function update(fn) {
      setState(s => {
        const regions = {};
        Object.keys(s.regions).forEach(k => regions[k] = [...s.regions[k]]);
        return fn({
          ...s,
          regions
        });
    ...
    function addBlock(region, type, index) {
      update(s => {
        const arr = s.regions[region] || (s.regions[region] = []);
        const nb = mkBlock(type);
        arr.splice(index == null ? arr.length : index, 0, nb);
        return s;
      });
    }
    function moveBlock(id, from, to, index) {
      update(s => {
        const fa = s.regions[from];
        const i = fa.findIndex(b => b.id === id);
        if (i < 0) return s;
        const [blk] = fa.splice(i, 1);
        const ta = s.regions[to] || (s.regions[to] = []);
        let ti = index == null ? ta.length : index;
        if (from === to && i < ti) ti -= 1;
        ta.splice(ti, 0, blk);
        return s;
      });
    }
    function removeBlock(id, region) {
      update(s => {
        s.regions[region] = s.regions[region].filter(b => b.id !== id);
        return s;
      });
      setSel(null);
    }
    function nudge(id, region, dir) {
      update(s => {
        const a = s.regions[region];
    ...
    function setProp(id, region, key, val) {
      update(s => {
        s.regions[region] = s.regions[region].map(b => b.id === id ? {
          ...b,
          props: {
            ...b.props,
            [key]: val
    ...
    function onDropRegion(region, index, e) {
      ...
      DRAG = null;
      if (!d) return;
      if (d.kind === "new") addBlock(region, d.type, index);else if (d.kind === "move") moveBlock(d.id, d.region, region, index);
    }
    const selBlock = (() => {
      if (!sel) return null;
      for (const rn of regionOrder) {
        const b = (state.regions[rn] || []).find(x => x.id === sel);
        if (b) return {
          ...b,
          region: rn
        };
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement("strong", null, "CRM Page Builder"), /*#__PURE__*/React.createElement("span", {
      className: "crmb-tag"
    ...
    }), /*#__PURE__*/React.createElement(ButtonMenu, {
      label: lay.label,
      iconName: "utility:chevrondown",
      items: Object.keys(layouts).map(lid => ({
        label: layouts[lid].label,
        iconName: layouts[lid].icon,
        checked: lid === state.layout,
      ...
      variant: preview ? "brand" : "neutral",
      iconName: "utility:preview",
      label: preview ? "Editing off" : "Preview",
      onClick: () => {
        setPreview(p => !p);
        setSel(null);
      }
      ...
      className: "crmb-body"
    }, !preview && /*#__PURE__*/React.createElement("aside", {
      className: "crmb-palette"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-palette-h"
    }, "Components"), /*#__PURE__*/React.createElement("p", {
      className: "crmb-hint"
    }, "Drag onto the page, or click to add. Select a block to edit its properties."), groupOrder().map(g => /*#__PURE__*/React.createElement("div", {
      key: g,
      className: "crmb-group"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-group-h"
    }, g), catalog.filter(c => c.group === g).map(c => /*#__PURE__*/React.createElement("div", {
      key: c.type,
      className: "crmb-pitem",
      draggable: true,
      onDragStart: () => DRAG = {
        kind: "new",
        type: c.type
      ...
      className: "crmb-pitem-l"
    }, c.label), /*#__PURE__*/React.createElement("div", {
      className: "crmb-pitem-d"
    }, c.desc)), /*#__PURE__*/React.createElement(Icon, {
      iconName: "utility:drag_and_drop",
      size: "xx-small"
    })))))), /*#__PURE__*/React.createElement("main", {
      className: "crmb-canvas",
      onClick: () => setSel(null)
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-page",
      onClick: e => e.stopPropagation()
    }, lay.rows.map((row, ri) => /*#__PURE__*/React.createElement("div", {
      key: ri,
      className: "crmb-row",
      style: {
        display: "flex",
    ...
    }, row.map(cell => /*#__PURE__*/React.createElement("div", {
      key: cell.region,
      style: {
        flex: cell.flex,
        minWidth: 0
      ...
      className: "crmb-inspect"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-palette-h"
    }, selBlock ? "Properties" : "Inspector"), selBlock ? /*#__PURE__*/React.createElement("div", {
      className: "crmb-insp-body"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-insp-title"
    }, /*#__PURE__*/React.createElement(Icon, {
      iconName: byType[selBlock.type].icon,
      size: "small"
    }), /*#__PURE__*/React.createElement("strong", null, byType[selBlock.type].label)), /*#__PURE__*/React.createElement("p", {
      className: "crmb-insp-desc"
    }, byType[selBlock.type].desc), (byType[selBlock.type].props || []).length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "crmb-props"
    }, byType[selBlock.type].props.map(pr => /*#__PURE__*/React.createElement(PropEditor, {
      key: pr.k,
      pr: pr,
      value: selBlock.props[pr.k],
      onChange: v => setProp(selBlock.id, selBlock.region, pr.k, v)
    }))), /*#__PURE__*/React.createElement("dl", {
      className: "crmb-meta"
    }, /*#__PURE__*/React.createElement("dt", null, "Region"), /*#__PURE__*/React.createElement("dd", null, regionLabels[selBlock.region] || selBlock.region), /*#__PURE__*/React.createElement("dt", null, "App Builder"), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("code", null, byType[selBlock.type].flexipage)), /*#__PURE__*/React.createElement("dt", null, "LWC base"), /*#__PURE__*/React.createElement("dd", null, /*#__PURE__*/React.createElement("code", null, byType[selBlock.type].lwc))), /*#__PURE__*/React.createElement("div", {
      className: "crmb-insp-actions"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: "0.5rem"
      ...
      iconName: "utility:up",
      label: "Up",
      onClick: () => nudge(selBlock.id, selBlock.region, -1)
    }), /*#__PURE__*/React.createElement(Button, {
      variant: "neutral",
      size: "small",
      iconName: "utility:down",
      ...
      label: "Remove",
      onClick: () => removeBlock(selBlock.id, selBlock.region)
    }))) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
      className: "crmb-hint",
      style: {
        padding: "0 0.875rem"
      }
    }, "Select a component to edit its properties and see its App Builder & LWC mapping."), /*#__PURE__*/React.createElement("div", {
      className: "crmb-pagecard"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-pagecard-h"
    }, /*#__PURE__*/React.createElement(Icon, {
      iconName: pageTypes[state.pageType].objectIcon,
      size: "small"
    }), /*#__PURE__*/React.createElement("strong", null, state.settings.label)), /*#__PURE__*/React.createElement("dl", {
      className: "crmb-meta",
      style: {
        margin: "0.5rem 0 0"
      }
    }, /*#__PURE__*/React.createElement("dt", null, "Type"), /*#__PURE__*/React.createElement("dd", null, pageTypes[state.pageType].label), /*#__PURE__*/React.createElement("dt", null, "Layout"), /*#__PURE__*/React.createElement("dd", null, lay.label), state.settings.object ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("dt", null, "Object"), /*#__PURE__*/React.createElement("dd", null, state.settings.object)) : null), /*#__PURE__*/React.createElement(Button, {
      variant: "neutral",
      size: "small",
      iconName: "utility:settings",
      label: "Page settings",
      ...
      className: "crmb-insp-foot"
    }, /*#__PURE__*/React.createElement(Icon, {
      iconName: "utility:info",
      size: "xx-small"
    }), /*#__PURE__*/React.createElement("span", null, "Properties flow into the export, so the generated FlexiPage & LWC match this design.")))), exp && /*#__PURE__*/React.createElement(ExportModal, {
      state: state,
    ...
    function Region({
      ...
      return /*#__PURE__*/React.createElement("section", {
        className: `crmb-region ${isOver ? "over" : ""} ${blocks.length ? "" : "empty"}`,
        onDragOver: e => {
          e.preventDefault();
          setOver(name);
        },
      ...
      }, blocks.length === 0 && !preview && /*#__PURE__*/React.createElement("div", {
        className: "crmb-empty"
      }, /*#__PURE__*/React.createElement(Icon, {
        iconName: "utility:add",
        size: "small"
      }), /*#__PURE__*/React.createElement("span", null, "Drag here"), /*#__PURE__*/React.createElement("em", null, regionLabels[name] || name)), blocks.map((blk, i) => /*#__PURE__*/React.createElement(PlacedBlock, {
        key: blk.id,
        blk: blk,
        region: name,
        index: i
    ...
    function PlacedBlock({
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: `crmb-block ${selected ? "sel" : ""} ${preview ? "preview" : ""}`,
        draggable: !preview,
        onDragStart: e => {
          DRAG = {
            kind: "move",
        ...
        onDrop: e => {
          if (!preview) onDropRegion(region, index, e);
        },
        onClick: e => {
          if (!preview) {
            e.stopPropagation();
        ...
        className: "crmb-block-name"
      }, byType[blk.type].label), /*#__PURE__*/React.createElement("button", {
        className: "crmb-ic",
        title: "Up",
        onClick: e => {
          e.stopPropagation();
          nudge(blk.id, region, -1);
        }
      }, "\u25B2"), /*#__PURE__*/React.createElement("button", {
        className: "crmb-ic",
        title: "Down",
        ...
        className: "crmb-ic del",
        title: "Remove",
        onClick: e => {
          e.stopPropagation();
          removeBlock(blk.id, region);
        }
      }, "\u2715")), /*#__PURE__*/React.createElement("div", {
        className: "crmb-block-body"
      }, window.CRMBRender(blk.type, blk.props)));
    }
  }
  function PropEditor({
    pr,
    ...
    if (pr.t === "toggle") return /*#__PURE__*/React.createElement("div", {
      style: {
      ...
      label: pr.l,
      checked: !!value,
      onChange: e => onChange(e && e.target ? e.target.checked : !value)
    }));
    if (pr.t === "select") return /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: "0.625rem"
      }
    }, /*#__PURE__*/React.createElement(Select, {
    ...
    if (pr.t === "textarea") return /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: "0.625rem"
      }
    ...
    if (pr.t === "number") return /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: "0.625rem"
      }
    }, /*#__PURE__*/React.createElement(Input, {
  ...
  function SettingsModal({
    ...
    return /*#__PURE__*/React.createElement(Modal, {
      ...
      label: "Developer / API name",
      value: s.apiName,
      onChange: e => setS({
        ...s,
        apiName: e.target.value
      })
    }), state.pageType === "record" && /*#__PURE__*/React.createElement(Input, {
  ...
  function ExportModal({
    ...
    let code = "",
      ...
      lang = "";
    if (fmt === "flexi") {
      code = E.flexipage(state);
      filename = `${state.settings.apiName || "Page"}.flexipage-meta.xml`;
      lang = "XML";
    } else if (fmt === "json") {
      code = E.json(state);
      ...
      code = E.htmlMock(state);
      filename = "mockup-outline.html";
      lang = "HTML";
    } else {
      if (lwcFile === "html") {
        code = lwcOut.html;
        filename = lwcOut.htmlName;
        lang = "HTML";
      } else if (lwcFile === "js") {
        code = lwcOut.js;
        filename = lwcOut.jsName;
        lang = "JS";
      } else {
        code = lwcOut.meta;
        filename = lwcOut.metaName;
        lang = "XML";
      }
    }
    const formats = [{
      ...
      id: "json",
      label: "Layout JSON",
      sub: "portable descriptor",
      icon: "utility:json"
    }, {
      id: "mock",
      label: "Mockup",
      sub: "outline for designers",
      icon: "utility:image"
    }];
    return /*#__PURE__*/React.createElement(Modal, {
      isOpen: true,
      ...
      size: "large",
      title: "Export page",
      tagline: "Hand off to a designer or developer \u2014 pick a format.",
      footer: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
        variant: "neutral",
        label: "Close",
        onClick: onClose
      ...
      className: "crmb-export"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-export-rail"
    }, formats.map(f => /*#__PURE__*/React.createElement("button", {
      key: f.id,
      className: `crmb-fmt ${fmt === f.id ? "on" : ""}`,
      onClick: () => setFmt(f.id)
    }, /*#__PURE__*/React.createElement(Icon, {
      iconName: f.icon,
      size: "small"
    }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "crmb-fmt-l"
    }, f.label), /*#__PURE__*/React.createElement("div", {
      className: "crmb-fmt-s"
    }, f.sub))))), /*#__PURE__*/React.createElement("div", {
      className: "crmb-export-main"
    }, /*#__PURE__*/React.createElement("div", {
      className: "crmb-export-note"
    }, noteFor(fmt)), fmt === "lwc" && /*#__PURE__*/React.createElement("div", {
      className: "crmb-lwc-tabs"
    }, [["html", lwcOut.htmlName], ["js", lwcOut.jsName], ["meta", lwcOut.metaName]].map(([k, nm]) => /*#__PURE__*/React.createElement("button", {
      key: k,
      className: lwcFile === k ? "on" : "",
      onClick: () => setLwcFile(k)
    }, nm))), /*#__PURE__*/React.createElement("div", {
      className: "crmb-code-h"
    }, /*#__PURE__*/React.createElement("span", {
      className: "crmb-lang"
    }, lang), /*#__PURE__*/React.createElement("code", null, filename)), /*#__PURE__*/React.createElement("pre", {
      className: "crmb-code"
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "crm-builder/app.jsx", error: String((e && e.message) || e) }); }

// crm-builder/catalog.js
try { (() => {
...
(function () {
  ...
  const pageTypes = {
    record: {
      label: "Record Page",
      flexiType: "RecordPage",
      lwcTarget: "lightning__RecordPage",
      object: "Contact",
    ...
    app: {
      label: "App / Home Page",
      flexiType: "AppPage",
      lwcTarget: "lightning__AppPage,lightning__HomePage",
      object: "",
      objectIcon: "standard:home"
    }
  };
  ...
  const layouts = {
    "header-right": {
      label: "Header + Right Sidebar",
      icon: "utility:side_list",
      flexiTemplate: "flexipage:recordHomeTemplateDesktop",
      primary: "main",
      rows: [[{
        region: "header",
        flex: 1
    ...
    "header-left": {
      ...
      icon: "utility:side_list",
      flexiTemplate: "flexipage:recordHomeLeftSidebarTemplateDesktop",
      primary: "main",
      rows: [[{
        region: "header",
        flex: 1
    ...
    "one": {
      label: "One Region",
      icon: "utility:layout_banner",
      flexiTemplate: "flexipage:defaultTemplateDesktop",
      primary: "main",
      rows: [[{
        region: "header",
        flex: 1
    ...
    "two-even": {
      label: "Two Columns (Even)",
      icon: "utility:layout_two_column",
      flexiTemplate: "flexipage:twoColumnTemplateDesktop",
      primary: "left",
      rows: [[{
        region: "header",
        flex: 1
    ...
    "three": {
      label: "Three Columns",
      icon: "utility:layout_three_column",
      flexiTemplate: "flexipage:threeColumnTemplateDesktop",
      primary: "main",
      rows: [[{
        region: "header",
        flex: 1
    ...
    "pinned-left": {
      label: "Pinned Left + Main + Right",
      icon: "utility:pinned",
      flexiTemplate: "flexipage:pinnedLeftRegionTemplateDesktop",
      primary: "main",
      rows: [[{
        region: "left",
        flex: 1
  ...
  // ---- Record ----
  {
    ...
    group: "Record",
    region: "header",
    desc: "Record header: icon, name, key fields & actions",
    flexipage: "force:highlightsPanel",
    lwc: "lightning-card",
    props: [{
      k: "object",
      l: "Object",
    ...
    group: "Record",
    region: "header",
    desc: "Sales/case stage path with guidance",
    flexipage: "runtime_sales_path:path",
    lwc: "lightning-progress-indicator",
    props: [{
      k: "picklist",
      l: "Picklist field",
      t: "text",
    ...
    group: "Record",
    region: "main",
    desc: "Read/edit view of record fields",
    flexipage: "force:detailPanel",
    ...
    group: "Record",
    region: "sidebar",
    desc: "Inline view/edit of a parent record",
    flexipage: "force:relatedRecord",
    lwc: "lightning-record-form",
    props: [{
      k: "relationship",
      l: "Relationship",
    ...
    group: "Record",
    region: "main",
    desc: "A grouped section of record fields",
    flexipage: "flexipage:fieldSection",
    lwc: "lightning-record-form",
    props: [{
      k: "title",
      l: "Section title",
  ...
  {
    type: "relatedList",
    label: "Related List — Single",
    icon: "standard:related_list",
    group: "Related Lists",
    region: "main",
    desc: "One child object list (e.g. Opportunities)",
    flexipage: "force:relatedListSingleContainer",
    ...
    group: "Related Lists",
    region: "main",
    desc: "All related lists for the record",
    flexipage: "force:relatedListContainer",
    lwc: "lightning-tabset",
    props: [{
      k: "objects",
      l: "Objects (comma)",
      t: "text",
      d: "Opportunities, Cases, Files"
    }]
  },
  // ---- Activity & Collaboration ----
  {
    ...
    icon: "standard:timeline",
    group: "Activity & Collaboration",
    region: "sidebar",
    desc: "Chronological calls, emails & events",
    flexipage: "runtime_sales_activities:activityPanel",
    lwc: "lightning-card",
    props: [{
      k: "title",
      l: "Title",
    ...
    type: "activities",
    label: "Activities (Composer)",
    icon: "standard:task",
    group: "Activity & Collaboration",
    region: "main",
    desc: "Log a Call / New Task / Email tabs",
    flexipage: "runtime_sales_activities:activityComposer",
    lwc: "lightning-tabset",
    props: [{
      k: "tabs",
      l: "Tabs (comma)",
      t: "text",
      d: "Log a Call, New Task, Email"
    }]
  }, {
    type: "chatterFeed",
    label: "Chatter Feed",
    ...
    group: "Activity & Collaboration",
    region: "main",
    desc: "Record feed of posts & comments",
    flexipage: "forceChatter:feedContainer",
    lwc: "lightning-card",
    props: [{
      k: "title",
      l: "Title",
    ...
    type: "chatterPublisher",
    label: "Chatter Publisher",
    icon: "standard:feed",
    group: "Activity & Collaboration",
    region: "main",
    desc: "Post composer (text / poll / link)",
    flexipage: "forceChatter:publisher",
    lwc: "lightning-card",
    props: [{
      k: "placeholder",
      l: "Placeholder",
    ...
    group: "Activity & Collaboration",
    region: "sidebar",
    desc: "Topic tags assigned to the record",
    flexipage: "forceChatter:topics",
    lwc: "lightning-card",
    props: [{
      k: "topics",
      l: "Topics (comma)",
      t: "text",
      d: "Enterprise, Renewal, Strategic"
    }]
  },
  // ---- Lists & Tables ----
  {
    type: "listView",
    label: "List View",
    icon: "standard:datatable",
    group: "Lists & Tables",
    region: "main",
    desc: "Full object list view with toolbar",
    flexipage: "force:listViewManager",
    lwc: "lightning-datatable",
    props: [{
      k: "object",
      l: "Object",
    ...
    group: "Lists & Tables",
    region: "main",
    desc: "Generic sortable, selectable table",
    flexipage: "flexipage:datatable",
    lwc: "lightning-datatable",
    props: [{
      k: "selectable",
      l: "Selectable rows",
    ...
    type: "recentItems",
    label: "Recent Items",
    icon: "standard:recent",
    group: "Lists & Tables",
    region: "sidebar",
    desc: "Recently accessed records",
    flexipage: "force:recentItems",
    lwc: "lightning-card",
    props: [{
      k: "title",
      l: "Title",
  ...
  // ---- Analytics ----
  {
    ...
    group: "Analytics",
    region: "sidebar",
    desc: "Embedded report summary chart",
    flexipage: "force:reportChart",
    lwc: "lightning-card",
    props: [{
      k: "report",
      l: "Report name",
    ...
    group: "Analytics",
    region: "main",
    desc: "Embedded dashboard with KPIs",
    flexipage: "force:dashboard",
    lwc: "lightning-card",
    props: [{
      k: "dashboard",
      l: "Dashboard name",
    ...
    group: "Analytics",
    region: "header",
    desc: "Row of single-value KPI tiles",
    flexipage: "flexipage:metricsRow",
    lwc: "lightning-card",
    props: [{
      k: "kpis",
      l: "KPIs (label:value, …)",
      t: "textarea",
      d: "Open Pipeline: $1.2M\nClosed Won: $320K\nWin Rate: 42%"
    }]
  },
  // ---- Layout ----
  {
    ...
    region: "main",
    desc: "Tabbed region",
    flexipage: "flexipage:tab2",
    lwc: "lightning-tabset",
    props: [{
      k: "tabs",
      l: "Tab labels (comma)",
      t: "text",
      d: "Details, Related, News"
    }, {
      k: "variant",
      l: "Variant",
      t: "select",
      d: "standard",
      o: ["standard", "scoped", "vertical"]
    }]
  }, {
    type: "accordion",
    label: "Accordion",
    ...
    group: "Layout",
    region: "main",
    desc: "Stacked expand/collapse sections",
    flexipage: "flexipage:accordion",
    lwc: "lightning-accordion",
    props: [{
      k: "sections",
      l: "Sections (comma)",
      t: "text",
      d: "Contact Information, Additional Details"
    }, {
      k: "multiple",
      l: "Allow multiple open",
      t: "toggle",
      d: false
    }]
  }, {
    ...
    group: "Layout",
    region: "main",
    desc: "Titled container for any content",
    flexipage: "flexipage:card",
    lwc: "lightning-card",
    props: [{
      k: "title",
      l: "Title",
    ...
    type: "richText",
    label: "Rich Text",
    icon: "utility:richtextbox",
    group: "Layout",
    region: "sidebar",
    desc: "Static formatted text block",
    flexipage: "flexipage:richText",
    lwc: "lightning-formatted-rich-text",
    props: [{
      k: "content",
      l: "Content",
      t: "textarea",
      d: "Key Account. Strategic enterprise customer since 2021."
    }]
  },
  // ---- Productivity & Custom ----
  {
    ...
    group: "Productivity & Custom",
    region: "sidebar",
    desc: "Map with record address markers",
    flexipage: "force:map",
    lwc: "lightning-map",
    props: [{
      k: "address",
      l: "Address",
      t: "text",
      d: "415 Mission St, San Francisco, CA"
    }, {
      k: "zoom",
      l: "Zoom",
      t: "number",
    ...
    group: "Productivity & Custom",
    region: "main",
    desc: "A developer's own Lightning Web Component",
    flexipage: "c:customComponent",
    lwc: "c-custom-component",
    props: [{
      k: "tag",
      l: "Component tag",
      t: "text",
    ...
    group: "Productivity & Custom",
    region: "main",
    desc: "Embedded Visualforce page (iframe)",
    flexipage: "flexipage:visualforcePage",
    lwc: "lightning-card",
    props: [{
      k: "page",
      l: "VF page name",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "crm-builder/catalog.js", error: String((e && e.message) || e) }); }

// crm-builder/export.js
try { (() => {
...
(function () {
  ...
  function flexipage(state) {
    ...
    const regionXml = regionsOf(state).map(rn => {
      const items = (state.regions[rn] || []).map(blk => {
        ...
        const props = Object.entries(blk.props || {}).filter(([, v]) => v !== "" && v != null).map(([k, v]) => `                    <componentInstanceProperties>\n                        <name>${esc(k)}</name>\n                        <value>${esc(typeof v === "boolean" ? v : String(v).replace(/\n/g, " "))}</value>\n                    </componentInstanceProperties>`).join("\n");
        return ["                <itemInstances>", "                    <componentInstance>", `                        <componentName>${c.flexipage}</componentName>`, props, "                    </componentInstance>", "                </itemInstances>"].filter(Boolean).join("\n");
      }).join("\n");
      return ["        <flexiPageRegions>", `            <name>${rn}</name>`, "            <type>Region</type>", items || "            <!-- empty region -->", "        </flexiPageRegions>"].join("\n");
    }).join("\n");
    return ['<?xml version="1.0" encoding="UTF-8"?>', '<FlexiPage xmlns="http://soap.sforce.com/2006/04/metadata">', regionXml, `    <masterLabel>${esc(state.settings.label)}</masterLabel>`, state.pageType === "record" && state.settings.object ? `    <sobjectType>${esc(state.settings.object)}</sobjectType>` : null, "    <template>", `        <name>${layouts[state.layout].flexiTemplate}</name>`, "    </template>", `    <type>${pt.flexiType}</type>`, "</FlexiPage>"].filter(Boolean).join("\n");
  }
  ...
  function lwc(state) {
    ...
    const js = ["import { LightningElement, api } from 'lwc';", "", `export default class ${className} extends LightningElement {`, "    @api recordId;", "    @api objectApiName;", "", "    currentStep = 'neg';", "    detailFields = ['Title', 'AccountId', 'Phone', 'Email', 'Department', 'LeadSource'];", "    accountFields = ['Name', 'Industry', 'Phone'];", "    richText = '<b>Key Account.</b> Strategic enterprise customer.';", "    mapMarkers = [];", "", "    // Replace with wire adapters (getRecord / getListUi / GraphQL) for live data.", "    columns = [", "        { label: 'Name', fieldName: 'name' },", "        { label: 'Amount', fieldName: 'amount', type: 'currency' },", "        { label: 'Stage', fieldName: 'stage' },", "    ];", "    relatedColumns = this.columns;", "    records = [];", "    relatedRecords = [];", "    activities = [];", "}"].join("\n");
    const meta = ['<?xml version="1.0" encoding="UTF-8"?>', '<LightningComponentBundle xmlns="http://soap.sforce.com/2006/04/metadata">', "    <apiVersion>61.0</apiVersion>", "    <isExposed>true</isExposed>", "    <masterLabel>" + esc(state.settings.label) + "</masterLabel>", "    <targets>", pageTypes[state.pageType].lwcTarget.split(",").map(t => `        <target>${t}</target>`).join("\n"), "    </targets>", "</LightningComponentBundle>"].join("\n");
    return {
      dir,
      html,
      js,
  ...
  function json(state) {
    return JSON.stringify({
      page: {
        ...
        apiName: state.settings.apiName,
        description: state.settings.description,
        type: pageTypes[state.pageType].flexiType,
        object: state.settings.object,
        layout: state.layout,
        template: layouts[state.layout].flexiTemplate
      },
      regions: regionsOf(state).map(rn => ({
        name: rn,
        components: (state.regions[rn] || []).map(b => ({
          type: b.type,
          label: byType[b.type].label,
          flexipageComponent: byType[b.type].flexipage,
          lwcBaseComponent: byType[b.type].lwc,
          properties: b.props
        }))
      }))
    }, null, 2);
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "crm-builder/export.js", error: String((e && e.message) || e) }); }

// crm-builder/render.jsx
try { (() => {
...
(function () {
  ...
  const OPP_ROWS = [{
    ...
    id: "3",
    name: "Global Media — Add-on",
    amount: "$45,000",
    stage: "Proposal",
    close: "9/15/2026"
  }, {
    id: "4",
    name: "Global Media — Pilot",
    amount: "$18,000",
    stage: "Qualification",
    close: "10/2/2026"
  }, {
    id: "5",
    name: "Global Media — Services",
    amount: "$96,000",
    stage: "Proposal",
    close: "9/28/2026"
  }];
  ...
  const fieldGrid = (fields, cols) => /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: "var(--slds-g-text-body-regular)",
      color: f.link ? "var(--slds-g-color-accent-1)" : "var(--slds-g-color-on-surface-1)"
    }
  }, f.value))));
  const oppCols = cols => cols.map(c => ({
    ...c,
    render: c.key === "stage" ? v => /*#__PURE__*/React.createElement(Badge, {
      variant: v === "Closed Won" ? "success" : "brand",
      label: v
    }) : undefined
  }));
  const shell = (title, icon, children, actions) => /*#__PURE__*/React.createElement(Card, {
    title: title,
    iconName: icon,
    actions: actions
  }, children);
  const plain = children => /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--slds-g-color-surface-container-1)",
      border: "1px solid var(--slds-g-color-border-1)",
      borderRadius: "var(--slds-g-radius-border-4)",
  ...
  const R = {
    highlights: p => /*#__PURE__*/React.createElement("div", {
      style: {
        background: "var(--slds-g-color-surface-container-1)",
        border: "1px solid var(--slds-g-color-border-1)",
        borderRadius: "var(--slds-g-radius-border-4)",
    ...
    }, p.object), /*#__PURE__*/React.createElement("h2", {
      style: {
        fontSize: "var(--slds-g-text-heading-large)",
        margin: "0.0625rem 0"
      }
    }, p.recordName)), p.showActions && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: "0.5rem"
      }
    ...
    }, FIELDS.slice(2, 6).map((f, i) => /*#__PURE__*/React.createElement("div", {
      key: i
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "var(--slds-g-text-body-small)",
    ...
    path: p => plain(/*#__PURE__*/React.createElement(ProgressIndicator, {
      variant: "path",
      current: Number(p.current) || 0,
      steps: PATH
    })),
    recordDetail: p => shell("Details", "utility:record_lookup", fieldGrid(p.columns === "1" ? FIELDS.slice(0, 4) : FIELDS, Number(p.columns) || 2), /*#__PURE__*/React.createElement(ButtonIcon, {
      variant: "bare",
      iconName: "utility:edit",
      title: "Edit",
      size: "small"
    })),
    relatedRecord: p => shell(p.title, "standard:account", fieldGrid([{
      label: "Account Name",
      value: "Global Media",
      link: true
    }, {
      ...
      label: "Owner",
      value: "Austin Guevara"
    }, {
      label: "Phone",
      value: "(415) 555-1212"
    }], 1)),
    fieldSection: p => shell(p.title, "utility:layout", fieldGrid(FIELDS.slice(0, 6), Number(p.columns) || 2)),
    relatedList: p => shell(`${p.title} (${Math.min(Number(p.rows) || 3, OPP_ROWS.length)})`, "standard:related_list", /*#__PURE__*/React.createElement(Datatable, {
      columns: oppCols(OPP_COLS),
      rows: OPP_ROWS.slice(0, Number(p.rows) || 3)
    }), /*#__PURE__*/React.createElement(Button, {
      variant: "neutral",
      size: "small",
      label: "New"
    })),
    relatedLists: p => /*#__PURE__*/React.createElement(RelatedLists, {
      objects: splitList(p.objects)
    }),
    activity: p => shell(p.title, "standard:timeline", /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: "0.875rem"
    ...
    activities: p => /*#__PURE__*/React.createElement(TabBlock, {
      tabs: splitList(p.tabs),
      kind: "activities"
    }),
    chatterFeed: p => shell(p.title, "standard:feed", /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: "0.875rem"
    ...
    }, "Austin Guevara"), " ", /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "var(--slds-g-text-body-small)",
        color: "var(--slds-g-color-on-surface-3)"
      }
    }, "\xB7 3h ago"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "var(--slds-g-text-body-regular)",
        marginTop: 2
      }
    }, "Renewal call went well \u2014 sending updated proposal today."))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: "0.625rem"
      }
    ...
    }, "Lando Voss"), " ", /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "var(--slds-g-text-body-small)",
        color: "var(--slds-g-color-on-surface-3)"
      }
    }, "\xB7 Yesterday"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "var(--slds-g-text-body-regular)",
        marginTop: 2
      }
    }, "Looking forward to it. Let's align on terms."))))),
    chatterPublisher: p => shell("Share", "standard:feed", /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "0.625rem 0.75rem",
        border: "1px solid var(--slds-g-color-border-2)",
        borderRadius: "var(--slds-g-radius-border-3)",
    ...
    }, p.placeholder), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "flex-end",
        gap: "0.5rem",
    ...
    topics: p => shell("Topics", "standard:topic", /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexWrap: "wrap",
        gap: "0.375rem"
      }
    }, splitList(p.topics).map((t, i) => /*#__PURE__*/React.createElement(Pill, {
      key: i,
      label: t
    })))),
    listView: p => /*#__PURE__*/React.createElement(ListView, {
      p: p
    }),
    dataTable: p => shell("Data Table", "standard:datatable", /*#__PURE__*/React.createElement(Datatable, {
      selectable: !!p.selectable,
      columns: oppCols(OPP_COLS),
      rows: OPP_ROWS.slice(0, Number(p.rows) || 3)
    })),
    recentItems: p => shell(p.title, "standard:recent", /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: "0.625rem"
      }
    }, CONTACT_ROWS.slice(0, Number(p.rows) || 4).map(c => /*#__PURE__*/React.createElement("div", {
      key: c.id,
      style: {
        display: "flex",
        alignItems: "center",
    ...
    }, c.title, " \xB7 ", c.account)))))),
    reportChart: p => shell(p.report, "standard:report", /*#__PURE__*/React.createElement(Chart, {
      type: p.chartType
    })),
    dashboard: p => shell(p.dashboard, "standard:dashboard", /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
    ...
    metrics: p => /*#__PURE__*/React.createElement(Metrics, {
      text: p.kpis
    }),
    tabs: p => /*#__PURE__*/React.createElement(TabBlock, {
      tabs: splitList(p.tabs),
      variant: p.variant,
      kind: "record"
    }),
    accordion: p => plain(/*#__PURE__*/React.createElement(Accordion, {
      allowMultiple: !!p.multiple,
      defaultActive: [0],
      sections: splitList(p.sections).map((s, i) => ({
        id: i,
        label: s,
        content: fieldGrid(FIELDS.slice(i % 2 ? 4 : 0, i % 2 ? 8 : 4), 2)
      }))
    })),
    card: p => shell(p.title, p.icon || "standard:report", /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: "var(--slds-g-text-body-regular)",
        color: "var(--slds-g-color-on-surface-2)"
      }
    }, "Drop any content here \u2014 fields, charts, or a custom component.")),
    richText: p => /*#__PURE__*/React.createElement("div", {
      style: {
        background: "var(--slds-g-color-surface-container-1)",
        border: "1px solid var(--slds-g-color-border-1)",
        borderRadius: "var(--slds-g-radius-border-4)",
    ...
    map: p => shell("Location", "standard:address", /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        height: 120,
        borderRadius: "var(--slds-g-radius-border-3)",
        background: "linear-gradient(135deg,#e8eef6,#dbe7f5)",
        position: "relative",
        overflow: "hidden",
        border: "1px solid var(--slds-g-color-border-1)"
      }
    ...
    customLwc: p => /*#__PURE__*/React.createElement("div", {
      style: {
        border: "1px dashed var(--slds-g-color-accent-1)",
        borderRadius: "var(--slds-g-radius-border-4)",
      ...
      style: {
        marginTop: "0.5rem",
        fontFamily: "var(--slds-g-font-family-mono)",
        fontSize: "var(--slds-g-text-body-regular)",
    ...
    }, p.label, " \u2014 custom Lightning Web Component")),
    visualforce: p => shell(p.page, "utility:page", /*#__PURE__*/React.createElement("div", {
      style: {
        height: Math.min(Number(p.height) || 320, 200),
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        border: "1px solid var(--slds-g-color-border-2)",
    ...
    }, "Visualforce: ", p.page, " (", p.height, "px)"))
  };
  function Chart({
    type
  }) {
    ...
    if (type === "donut") {
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          height: 110,
          borderRadius: "50%",
          background: "conic-gradient(var(--slds-g-color-accent-1) 0 45%, #57a3fd 45% 70%, #aacbff 70% 88%, var(--slds-g-color-surface-3) 88% 100%)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center"
        }
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, vals.map((h, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        flex: 1,
        display: "flex",
      ...
      style: {
        ...
        height: `${h}%`,
        background: "var(--slds-g-color-accent-1)",
        borderRadius: "var(--slds-g-radius-border-2) var(--slds-g-radius-border-2) 0 0",
        opacity: 0.45 + i * 0.12
      }
    }), /*#__PURE__*/React.createElement("span", {
      style: {
  ...
  function Metrics({
    ...
    const kpis = String(text || "").split("\n").map(l => l.split(":")).filter(a => a.length >= 2).map(a => ({
      label: a[0].trim(),
  ...
  function ListView({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, p.object), /*#__PURE__*/React.createElement("div", {
      style: {
        fontWeight: "var(--slds-g-font-weight-bold)",
        fontSize: "var(--slds-g-text-heading-small)"
      }
    }, p.view)), /*#__PURE__*/React.createElement(Button, {
      variant: "neutral",
      label: "Import"
    }), /*#__PURE__*/React.createElement(Button, {
      variant: "brand",
      ...
      rows: CONTACT_ROWS.slice(0, Number(p.rows) || 5),
      style: {
        border: 0,
        borderRadius: 0,
        boxShadow: "none"
  ...
  function TabBlock({
    ...
    const [tab, setTab] = React.useState(0);
    let body;
    if (kind === "activities") body = /*#__PURE__*/React.createElement("div", {
      style: {
        color: "var(--slds-g-color-on-surface-2)",
        fontSize: "var(--slds-g-text-body-regular)"
      }
    }, list[tab], " composer \u2014 subject, date, related to\u2026");else if (tab === 0) body = fieldGrid(FIELDS.slice(0, 6), 2);else if (tab === 1) body = /*#__PURE__*/React.createElement(Datatable, {
      columns: oppCols(OPP_COLS),
      rows: OPP_ROWS.slice(0, 3)
    ...
    }, "No recent ", list[tab].toLowerCase(), ".");
    return /*#__PURE__*/React.createElement("div", {
      style: {
        background: "var(--slds-g-color-surface-container-1)",
        border: "1px solid var(--slds-g-color-border-1)",
  ...
  window.CRMBRender = function (type, props) {
    const fn = R[type];
    return fn ? fn(props || {}) : /*#__PURE__*/React.createElement("div", {
      style: {
        padding: 12,
        color: "var(--slds-g-color-on-surface-3)"
      }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "crm-builder/render.jsx", error: String((e && e.message) || e) }); }
